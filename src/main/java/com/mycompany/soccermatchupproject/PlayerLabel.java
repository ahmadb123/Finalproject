...
import static com.mycompany.soccermatchupproject.MainWindow.getScaledIcon;
import gsonGetApi.TopScorerApi;
...
public class PlayerLabel {
    ...
    public List<JLabel[]> getTeamsStandings() {
        ...
        getTeamInfoApi response = getTeamInfoApi.getTeamInfo(homeTeam);

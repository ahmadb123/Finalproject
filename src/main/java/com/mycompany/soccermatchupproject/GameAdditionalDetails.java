...
public class GameAdditionalDetails extends javax.swing.JFrame {
   ...
   private void initGameDetails() {
    ...
    private void TeamOnePlayersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TeamOnePlayersActionPerformed
    ...
    private void teamTwoPlayersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_teamTwoPlayersActionPerformed
        PlayerLabel playerLabel = new PlayerLabel(gameIndex);
